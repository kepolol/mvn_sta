...
; D1
	if size(mvn_d1_dat,/type) eq 8 then begin
		...
		pos_sc_mso = mvn_d1_dat.pos_sc_mso ;Ivan
...
;		this section needed because eflux in the CDFs got screwed up
		...
		store_data, 'pos_sc_mso',data={x:time,y:pos_sc_mso} ;Ivan
		split_vec,'pos_sc_mso';Ivan
		calc, "'altitude'=sqrt('pos_sc_mso_x'^2+'pos_sc_mso_y'^2+'pos_sc_mso_z'^2)-3390"
